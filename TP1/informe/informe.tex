...
\begin{itemize}
	...
	\item{pySankey \footnote{\url{https://github.com/anazalea/pySankey/}}: Para los Sankey diagrams (diagramas de flujo)}
...
Alternativamente, se puede optar por reproducir el kernel en la plataforma Kaggle y evitar conflictos de entorno.
