...
\begin{figure}[h!]
	\includegraphics[width=\linewidth]{figures/02-eventos_segun_mes-heatmap.png}
...
\begin{figure}[h!]
	\includegraphics[width=\linewidth]{figures/03-eventos_segun_dow-heatmap.png}
	\caption{Eventos segun mes y día}
...
\begin{figure}[h!]
	\includegraphics[width=\linewidth]{figures/04-eventos_segun_mes-barplot.png}
