...
Se busca determinar qué marcas son las que reúnen la mayor cantidad de eventos. Esto puede ser ya sea porque son las marcas más compradas, más buscadas, más vistas, entre otros eventos. Este análisis es más bien global ya que no es específico a un evento determinado.
...
Se conserva el comportamiento presentado en la sección \texttt{Análisis de búsquedas} con respecto a los términos más buscados. Las marcas que registran mayor cantidad de eventos son iPhone, Motorola y Samsung.

Ahora se busca analizar cuáles marcas son las que realizan una cantidad pareja de checkouts y conversiones. Se predice que las marcas que venden celulares de precios elevados como Apple van a mostrar una cantidad mayor de checkouts a conversiones. Así mismo, las marcas que mantienen un precio más accesible van a tener ambas cantidades más parejas. 
...
Se observa en la figura \ref{fig:brands} que la relación checkout-conversions para las marcas representadas es relativamente constante para todas las marcas, con algunas excepciones marcadas donde la cantidad de conversiones es muy chica, como asus, ipad o quantum. Igualmente podría afirmarse que la predicción es cierta porque esta relación es mayor en la marca Samsung que en la marca iPhone/Apple.
