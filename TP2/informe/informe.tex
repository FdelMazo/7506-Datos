...
El objetivo de este notebook es encontrar los hiperparámetros y los parámetros óptimos para cada algoritmo implementado. Para ello se utiliza el algoritmo de \texttt{Grid Search} que se encarga de probar todas las combinaciones de una lista de valores posibles para cada parámetro. Estos valores fueron investigados de diversas fuentes que serán mencionadas en la bibliorafía debido a que es difícil fijar una frontera de valores sin una guía del área. Combinando las fuentes y el conocimiento de la funcionalidad de cada parámetro se llegó a los valores que se podrían considerar óptimos de los parámetros de los algoritmos. 
