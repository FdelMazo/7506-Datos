...
\begin{figure}[!h]
	\makebox[\textwidth][c]{\includegraphics[width=0.8\textwidth]{figures/labels-2d.png}}
...
\begin{figure}[!h]
	\makebox[\textwidth][c]{\includegraphics[width=0.8\textwidth]{figures/kmeans-4.png}}
...
\begin{figure}[!h]
	\makebox[\textwidth][c]{\includegraphics[width=0.8\textwidth]{figures/hdbscan-36.png}}
