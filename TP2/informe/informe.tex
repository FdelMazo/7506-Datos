...
\begin{figure}[!h]
	\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{figures/labels-2d.png}}
...
\begin{figure}[!h]
	\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{figures/kmeans-4.png}}
...
\begin{figure}[!h]
	\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{figures/hdbscan-36.png}}
...
En este caso seguimos manejando modelos de la familia boosting. 

Adaboosting comienza con un clasificador simple que va siendo modificado dependiendo su nivel de error. En cada iteración se le da peso a la clase que mejor resultado obtuvo. Luego se vuelve a iterar. 

Una vez finalizadas las iteraciones crea un promedio ponderado. Esta combinación lineal de los N clasificadores va a ser su clasificador final.
