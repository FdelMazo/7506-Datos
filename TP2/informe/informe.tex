...
Para un desarrollo más cómodo, se modularizó el trabajo en distintos notebooks de Jupyter, y luego se importan entre si \footnote{Haciendo uso del magnífico \href{https://github.com/grst/nbimporter}{nbimporter}}, intentando emular la programación estructurada. Si bien esta forma de trabajar sirve bastante para no estar repitiendo código, el dividir en distintos notebooks que dependan unos de otros sube el acoplamiento del proyecto en su totalidad.
...
\begin{enumerate} 
	...
	En este notebook se presentan las distintas exploraciones que se hicieron sobre el dataset del trabajo previo y del actual, en busqueda de ideas útiles para el desarrollo de este.
...
\begin{itemize}
	...
	\item \textbf{\texttt{total\_ad\_sessions}}: cantidad total de sesiones donde el usuario ingresó por primera vez por una campaña publicitaria.
\end{itemize}
	
A partir de estos features se deducen los siguientes:

\begin{itemize}
	\item \textbf{\texttt{avg\_events\_per\_session}}: porcentaje de cantidad total de eventos sobre cantidad de sesiones
	\item \textbf{\texttt{avg\_events\_per\_ad\_session}}: porcentaje de cantidad total de eventos donde el usuario ingresó por una campaña publicitaria sobre cantidad total de sesiones donde el usuario ingresó por una campaña publicitaria
